...
h = 'hello 黄文凯'.encode("ASCII", 'replace')
...
print('*********************')
print(a1, ':', str(a1, 'utf-8'))  # b'\xe9\xbb\x84\xe7\x9b\x8a\xe5\x87\x9b' : 黄文凯
print(b1, ':', str(b1, 'utf-32'))  # b'\xff\xfe\x00\x00\xc4\x9e\x00\x00\xcav\x00\x00\xdbQ\x00\x00' : 黄文凯
